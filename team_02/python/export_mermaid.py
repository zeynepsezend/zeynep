"""
export_mermaid.py -- Export the Sensi graph as a Mermaid diagram  (v3)

The _DIAGRAM constant below IS the diagram for the v3 architecture.
Running this script:
